...
class VVLDconsume(controller: SparkSessionProvider) extends Job{
  ...
  val gcsCheckPointPath = s"$GCSkafkaLanding/vvld/checkpoints1"
  val gcsLoadPath = s"$GCSkafkaLanding/vvld/delta1"
